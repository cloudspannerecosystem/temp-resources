...
// [START spanner_get_database_ddl_proto_descriptor]
import (
	"context"
	"fmt"
	"io"
...
func getDatabaseDdlProtoDescriptor(w io.Writer, db string) error {
...
// [END spanner_get_database_ddl_proto_descriptor]
